...
```{r}
#| echo: false
#| label: tbl-regmeannediansdmad-dos
...
## Dos gráficos en el mismo cuadro
...
my_data |> 
  ...
  ggplot(aes(Nivel_Educativo,Mediana,fill=Sexo))+
  geom_col(position="dodge")
```

```{r}
#| label: fig-dos-graficos
#| echo: false
#| fig-cap: 
#|  - "Mujer"
#|  - "Hombre"
...
my_data |> 
  ...
  ggplot(aes(Nivel_Educativo,Mediana))+
  geom_col(fill = "red")
