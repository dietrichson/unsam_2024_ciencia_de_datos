...
En este capítulo se realizará un análisis cuantitativo del régimen de tenencia de vivienda según cada región de Argentina. Para ello, se utilizarán datos del Instituto Nacional de Estadística y Censos (INDEC) (Censos y estadísticas 2023). Los datos especifican los siguientes regímenes de tenencia:
